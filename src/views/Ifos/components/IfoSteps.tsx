  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('Stake SLCT in IFO pool')}
      </Heading>
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of SLCT user can commit to all the sales combined, is equal to the average SLCT balance in the IFO SLCT pool prior to the IFO. Stake more SLCT to increase the maximum SLCT you can commit to the sale. Missed this IFO? You can keep staking in the IFO SLCT Pool to join the next IFO sale.',
          )}
        </Text>
      ...
      {hasProfile && (
        <SmallStakePoolCard borderRadius="default" p="16px">
          <FlexGap justifyContent="space-between" alignItems="center" flexWrap="wrap" gap="16px">
            ...
            <Button onClick={onPresentStake}>{t('Stake')} SLCT</Button>
          </FlexGap>
        </SmallStakePoolCard>
      )}
    </CardBody>
...
const Step2 = ({ hasProfile, isLive, isCommitted }: { hasProfile: boolean; isLive: boolean; isCommitted: boolean }) => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” your SLCT to buy the tokens being sold.')} <br />
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active SilverlineSwap Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent SLCT tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )

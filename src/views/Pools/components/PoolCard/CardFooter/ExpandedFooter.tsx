  ...
  return (
    <ExpandedWrapper flexDirection="column">
      ...
      <Flex mb="2px" justifyContent="flex-end">
        <LinkExternal color='contrast' href={`/info/token/${earningToken.address}`} bold={false} small>
          {t('See Token Info')}
        </LinkExternal>
      </Flex>
      <Flex mb="2px" justifyContent="flex-end">
        <LinkExternal href={earningToken.projectLink} bold={false} color='contrast' small>
          {t('View Project Site')}
        </LinkExternal>
      </Flex>
      {poolContractAddress && (

...
const IFOCreditCell: React.FC<IFOCreditCellProps> = ({ account }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Text>
        {t(
          'Your entry limit in the next IFO sale is determined by your IFO credit. This is calculated by the average SLCT balance of the principal amount in the IFO pool during the last credit calculation period.',
        )}
      </Text>
      <Text>
        {t(

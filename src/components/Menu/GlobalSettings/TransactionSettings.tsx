      ...
      <Flex flexDirection="column" mb="24px">
        ...
        <Flex flexWrap="wrap" style={{gap:10}} >
          <Button
            ...
            variant={userSlippageTolerance === 10 ? 'primary_round' : 'tertiary'}
            p='0 10px'
          >
            0.1%
          </Button>
          <Button
            ...
            variant={userSlippageTolerance === 50 ? 'primary_round' : 'tertiary'}
            p='0 10px'
          >
            0.5%
          </Button>
          <Button
            ...
            variant={userSlippageTolerance === 100 ? 'primary_round' : 'tertiary'}
            p='0 10px'
          >
            1.0%
          </Button>

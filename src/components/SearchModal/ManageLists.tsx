...
const ListRow = memo(function ListRow({ listUrl }: { listUrl: string }) {
  ...
  return (
    <RowWrapper active={isActive} key={listUrl} id={listUrlRowHTMLId(listUrl)}>
      ...
      <Column style={{ flex: '1' }}>
        <Row>
          <Text color='invertedContrast' bold>{list.name}</Text>
        </Row>
        <RowFixed mt="4px">
          <Text color='invertedContrast' fontSize="12px" mr="6px" textTransform="lowercase">
            {list.tokens.length} {t('Tokens')}
          </Text>
          <span ref={targetRef}>
            <CogIcon color="invertedContrast" width="12px" />
          </span>
        </RowFixed>
      </Column>
      <Toggle
            ...
            <RowBetween>
              <RowFixed>
                ...
                <AutoColumn gap="4px" style={{ marginLeft: '20px' }}>
                  <Text color='invertedContrast' bold>{tempList.name}</Text>
                  <Text color='invertedContrast' small textTransform="lowercase">
              ...
              {isImported ? (
                <RowFixed>
                  ...
                  <Text color='invertedContrast' >{t('Loaded')}</Text>
                </RowFixed>
              ) : (
